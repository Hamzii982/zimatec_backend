...
@section('title', 'ZiMaTec GmbH - Passwort zurücksetzen')
    ...
    <div class="row g-0 min-vh-100">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-5">
                        <div class="d-flex align-items-center justify-content-center mb-3">
                            <i class="bi bi-arrow-counterclockwise fs-3 me-3"></i>
                            <span class="fs-5">{{ __('Passwort Wiederherstellung') }}</span>
                        </div>
                        <div class="d-flex align-items-center justify-content-center">
                            <i class="bi bi-envelope-check fs-3 me-3"></i>
                            <span class="fs-5">{{ __('Sicherer Link per E-Mail') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center p-4 p-md-5">
            <div class="login-form-container w-100" style="max-width: 450px;">
                ...
                <h2 class="fw-bold text-title mb-2 d-none d-lg-block">{{ __('Passwort vergessen?') }}</h2>
                <p class="text-muted mb-4">{{ __('Geben Sie Ihre E-Mail-Adresse ein. Wir senden Ihnen einen Link zum Zurücksetzen Ihres Passworts.') }}</p>
